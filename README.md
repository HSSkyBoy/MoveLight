# MoveLight - 虚拟移动光源插件
MoveLight 是一款专为 Minecraft 伺服器设计的轻量化移动光源插件。它利用「虚拟封包模式」，让玩家在手持或穿戴发光物品时，能够照亮周围环境，且不会对地图方块造成任何实质变更。
...
| 指令 | 说明 | 权限要求 |
| :--- | :--- | :--- |
| `/movel help` | 显示插件帮助选单 | `movelight.help` |
| `/movel toggle` | 全域开启或关闭移动光源功能 | `movelight.toggle` |
| `/movel reload` | 重载设定档并重新启动光源任务 | `movelight.reload` |

### 其他权限
* `movelight.player.use`：玩家是否能使用移动光源功能的基础权限（预设所有人拥有）。
